...
what we're working with. We'll start with our time series variable: the Listing
Creation Date.
...
This is a strange functional dependence of loan count per year over time. It 
looks like business was booming in the Prosper loan marketplace from its 
inception in 2006 until 2009, then it jumped back to its Year 1 level of loans
business. This could be due to a few things:
